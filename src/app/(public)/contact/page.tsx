...
export default function ContactPage() {
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
      <h1 className="text-3xl font-bold mb-2">Drop Us A Line</h1>
      <p className="text-gray-600 mb-8">Have a question? We're here to help</p>
      ...
      <div className="grid md:grid-cols-3 gap-12">
        ...
        <form className="md:col-span-2 space-y-4">
          ...
          <button className="w-full bg-black text-white py-4 font-bold hover:bg-gray-800 transition">
            SEND
          </button>
        </form>
        ...
        <div className="bg-gray-50 p-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-bold text-sm uppercase mb-1">Address:</h3>
